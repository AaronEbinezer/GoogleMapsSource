...
//     * @see GeoDataClient#getAutocompletePredictions(String, LatLngBounds, AutocompleteFilter)
    ...
    private ArrayList<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
        if (mGeoDataClient.isConnected()) {
            ...
            PendingResult<AutocompletePredictionBuffer> results = Places.GeoDataApi.getAutocompletePredictions(mGeoDataClient, constraint.toString(), mBounds, mPlaceFilter);
...
//            Tasks.await(results, 60, TimeUnit.SECONDS);
            ...
            try {
                ...
                if(!status.isSuccess())
                {
                    ...
                    Log.d(TAG,"Error in Api "+status.toString());
